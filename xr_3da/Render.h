...
//	virtual ui_shader				getShader				(int id)									= 0;
...
//	virtual void					add_StaticWallmark		(ui_shader& S, const Fvector& P, float s, CDB::TRI* T, Fvector* V)=0;
	...
	//virtual void					add_SkeletonWallmark	(const Fmatrix* xf, IKinematics* obj, ui_shader& sh, const Fvector& start, const Fvector& dir, float size)=0;
	//	Prefer this function when possible
